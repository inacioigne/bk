...
from src.routes.catalog import work, instance, catalog, items
...
app.include_router(instance.router, prefix="/catalog/instance", tags=["Catálogo"])
app.include_router(items.router, prefix="/catalog/items", tags=["Catálogo"])
